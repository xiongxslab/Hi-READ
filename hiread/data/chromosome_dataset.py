...
class ChromosomeDataset(Dataset):
    ...
    def __init__(self, celltype_root, chr_name, omit_regions, feature_list, use_aug = True):
        ...
        # self.use_aug = use_aug
        # self.res = 10000 # 10kb resolution
        # self.bins = 838.8608 # 838.8608 bins 2097152 bp
        # self.image_scale = 1024 # IMPORTANT, scale 210 to 256
        # self.sample_bins = 500
        # self.stride = 50 # bins
        # self.chr_name = chr_name
    ...
    def shift_aug(self, target_size, start, end):
        ...
        offset = random.choice(range(end - start - target_size)) if end - start - target_size > 0 else 0
...
if __name__ == '__main__':
    raise SystemExit("Import this module from dataset code.")
