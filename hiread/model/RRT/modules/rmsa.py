...
class InnerAttention(nn.Module):
    ...
    def forward(self, x, return_attn=False):
        ...
        attn_weights = attn.clone() if return_attn else None
...
class RegionAttntion(nn.Module):
    ...
    def forward(self,x,return_attn=False):
        ...
        # R-MSA
        if return_attn:
            attn_regions, attn_weights = self.attn(x_regions, return_attn=True)  # nW*B, region_size*region_size, C
        else:
