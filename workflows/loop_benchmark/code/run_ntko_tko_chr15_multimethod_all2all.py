#!/usr/bin/env python3
"""
Run all-to-all FitHiChIP loop calling on NTKO/TKO chr15 npy files across four methods
...
DEFAULT_EXPERIMENT_ROOT = str(
    Path(
        os.environ.get(
            ...
            RELEASE_ROOT / "release_assets" / "loop_benchmark" / "all2all_ntko_tko_chr15_20260325",
        )
    )
)
...
class NTKOTKOChr15MultiMethodAll2All:
    ...
    def _run_all_loops(self):
        ...
        print("=" * 80)
        print("NTKO/TKO chr15 多方法 all2all FitHiChIP 开始")
        print("=" * 80)
        ...
        with ThreadPoolExecutor(max_workers=self.parallel_jobs) as executor:
            ...
            for future in as_completed(future_to_task):
                ...
                print(
                    f"{status} {result['method_name']}/{result['dataset_name']} "
    ...
    def run(self):
        summary = {
            ...
            "parameters": {
                ...
                "force": self.force,
                "note": "NTKO/TKO chr15 only; all methods use all2all; RRTdiffusion uses final.npy only",
            },
            "loop_call_results": [],
            "comparison_results": [],
        }
...
def main():
    parser = argparse.ArgumentParser(
        description="NTKO/TKO chr15 多方法 all2all FitHiChIP + 对比"
    )
    parser.add_argument(
        "--experiment-root",
    ...
    runner = NTKOTKOChr15MultiMethodAll2All(
